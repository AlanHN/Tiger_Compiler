...
typedef struct A_fundecList_ *A_fundecList; //fuction declaration list
typedef struct A_namety_ *A_namety; // name type
typedef struct A_nametyList_ *A_nametyList; // name type list
typedef struct A_efield_ *A_efield; //record 
typedef struct A_efieldList_ *A_efieldList; //record list
