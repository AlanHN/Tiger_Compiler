...
// bool Temp_tempIn(Temp_tempList l, Temp_temp t)
// {
//   for (; l; l = l->tail)
//   {
//     if (l->head == t)
...
// Temp_tempList Temp_listDiff(Temp_tempList a, Temp_tempList b)
// {
//   Temp_tempList ret = NULL;
//   for (; a; a = a->tail)
//   {
//     if (!Temp_tempIn(b, a->head))
//     {
//       ret = Temp_TempList(a->head, ret);
//     }
//   }
//   return ret;
// }
...
// // a+b with duplicate
// Temp_tempList Temp_listSplice(Temp_tempList a, Temp_tempList b)
// {
//   if (a == NULL)
//     return b;
//   return Temp_TempList(a->head, Temp_listSplice(a->tail, b));
// }

// Temp_tempList Temp_listUnion(Temp_tempList a, Temp_tempList b)
// {
//   Temp_tempList d = Temp_listDiff(a, b);
//   return Temp_listSplice(a, d);
// }

// Temp_tempList Temp_listAppend(Temp_tempList l, Temp_temp t)
// {
//   if (Temp_tempIn(l, t))
//   {
//     return l;
...
// void Temp_tempReplace(Temp_tempList l, Temp_temp a, Temp_temp t2)
// {
//   for (; l; l = l->tail)
//   {
//     if (l->head == a)
